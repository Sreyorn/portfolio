    ...
    <div class="xl:mx-32 lg:mx-4">
      <div
        class="
          ...
          lg:mx-auto
          sm:grid
          lg:grid-cols-3 lg:grid-rows-2 lg:gap-8
          xl:gap-20
          space-y-2
        "
      >
...
export default {
  ...
  data() {
    return {
      work1: {
        img: "dobpi.png",
        about: "Tech Startup Company Based in Cambodia",
        position: "Intern Frontend Developer",
        techUse: "Frontend: Reactjs, Material-UI",
        url: "https://dobpi.shop/",
      },
      work2: {
        img: "kontent.png",
        about: "Stealth Mode Startup",
        position: "Junior Frontend Developer",
        techUse: "Frontend: Nextjs, Chakra-UI",
      },
      work3: {
        img: "space.png",
      ...
      work4: {
        ...
        url: "https://typelyrics.netlify.app/",
        other:"🟢 You Can Access This Site"
      },
      work5: {
        img: "dalgo.png",
        about: "Personal Project",
        ...
        url: "https://dalgo.netlify.app/",
        other:"🟢 You Can Acees This Site"
      },
      work6: {
        img: "cvl.png",
